...
public class App {
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream objetoSaida = new ObjectOutputStream(new FileOutputStream(C:\\Users\\danie\\OneDrive\\PROJ.JAVA\\produtos.dat)) {
            objetoSaida.writeObject(produtos);
        } catch (IOException e) {
            e.printStackTrace();
        }

        try (ObjectInputStream objetoEntrada = new ObjectInputStream(new FileInputStream("C:\\Users\\danie\\OneDrive\\PROJ.JAVA\\produtos.dat)) {
