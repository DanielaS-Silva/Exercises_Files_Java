...
public class App {
    private static final String FILE_PATH = "C:\\Users\\Daniela\\Documentos\\Exercises_Files_Java\\arquivo_binario\\exerc17\\funcionarios.dat";

    public static void main(String[] args) throws IOException {
        RandomAccessFile file = new RandomAccessFile(FILE_PATH, "rw");

        Funcionario funcionario = new Funcionario(1, "João", 2000.0);
